...
- simple
- extension
description: "Street view is one the most outstanding features of not just google maps, but any google project. Just think how many photos are needed, and then how do you stitch them together? Well here is a simple plugin so you can use it on your maps too!"
introduction: "<p>Street view is one the most outstanding features of not just google maps, but any google project. Just think how many photos are needed, and then how do you stitch them together?</p><p>Here is a simple plugin so you can use it on your maps too!</p>"
---

*EDIT: 26/10/2010* The street view man and all the triggers associated with it are now built in to v3 of google maps API, so please use that instead of this! 

h2. Summary

<div class='introduction curvy'>

* "Working example":#map_street_view
* "What is missing":#whats-missing from the street view API
* Details on "how to use the plugin":#using-street-view
* "Download":#download-files
* Big thanks to "Sheldon Els":http://sheldon.github.com/ for helping out
...
h2(#whats-missing). What's Missing
...
Strangely enough, it is on the google maps one. With a bit of reverse engineering that problem was overcome (big thanks to "Sheldon Els":http://sheldon.github.com/ for sorting that part out).
...
h2(#using-street-view). Using Street View
...
* control_container - id of container for the custom control (if the selector isn't there the markup is inserted)
* control_ui - id of container for part of the custom control
* control_text - id of container for part of the custom control
* street_view - the id of the container for the street view flash object (if the selector isn't there the markup is inserted)

h3(#download-files). The Files
