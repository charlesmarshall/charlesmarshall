...
First off, install GiT is super simple:
...
That should take you about 5 minutes. Once your done you need to get used to the command set. Many people (Mercurial & Bazaar uses, wonder why?) always complain about the number of commands Git has, but lets be honest here, in daily usage you use 6 commands:
