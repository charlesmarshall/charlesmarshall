...
After the past few months we've done some very media heavy adverts with much back and forth over image changes. As you can imagine, this can be troublesome especially when you have lots images, which are mostly tiffs, at about 150Mb each.

h2. Existing Tech

So any tech that can be used needs to be evaluated based on a few criteria, the "granny factor" and the technical viability. The "granny factor" is simple, would you 70 year old grandma be able to do it without supervision.

From the geek side of things it needs to be pain free (no one wants to spend hours answering emails about it), capable of handling large numbers of files, massive sizes and be fast.
...
Of course that size account is not free; it's $19.99 a month; thats the second problem, budget.
...
Simple is the key to the spread of the use of torrents. If a 12 year old can use it to download the latest top 10 it's a good bet your gran can handle it too.
