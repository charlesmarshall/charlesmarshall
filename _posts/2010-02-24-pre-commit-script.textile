...
<p class="read_more">
  <a href='/git-pre-commit-files/example_config.yml' title='example config' class='category curvy'>config file &raquo;</a>
  <a href='/git-pre-commit-files/hook.rb' title='hook rb script' class='category curvy'>ruby script &raquo;</a>
  <a href='/git-pre-commit-files/all.zip' title='zip' class='category curvy'>all files &raquo;</a>
</p>  