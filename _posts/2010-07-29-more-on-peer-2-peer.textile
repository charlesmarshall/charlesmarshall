...
So after my previous post, I did start (and mostly finished) a python app engine torrent server using memcache. The main thing left to do is sort out the compressed view... I've been very busy (more about that later), with a new project.
