...
- diff
- dropbox
description: "Amazon have set up version control on their S3 system; it is currently in Beta (isn't everything?) but looks like it could be very handy."
---

Amazon have set up "version control on their S3 system":http://doc.s3.amazonaws.com/betadesign/Versioning.html ; it is currently in Beta (isn't everything?) but looks like it could be very handy.
