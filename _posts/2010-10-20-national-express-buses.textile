...
Combining both layout cache with partial cache mechanism also means that (unless the cache is cleared) all pages are served from the cache with load times and size being tiny.

YSlow gives the site between 89 and 93 out of 100, depending on the page. Pretty good performance! 
