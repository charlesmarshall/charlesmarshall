...
* You can mix "static content":#fixed-content-fixed-language with "dynamic":#fixed-content-dynamic-language, so you can translate page content or form values, by simply switching the selector
