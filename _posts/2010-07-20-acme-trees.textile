...
introduction: "<img src='/images/work/acme-trees.png' alt='Acme Trees' /><p>Need help with that troublesome Fir? Issues with an overgrown Pine? Then these are the guys that can help</p>"
---
...
It has some nice fading between images on the home page (jQuery for the win!) and good visual touches like the custom bullet point images.
