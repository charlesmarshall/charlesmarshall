(function($) {
	...
	$.diagonalaccordion = {
		...
		addtargets:function(elenum, bar){
			...
			var offsetx = jQ(container).eq(0).offset().left+(params.bar_size*(barnum-1));
			var offsety = h.toppos;
			var numtargets = Math.round(h.cheight/size);
	...
	$.fn.diagonalaccordion.defaults = {acc_width:500, acc_height:300,bar_size:45, speed:'slow', accordion:'.accordion'};
